...
| 0201   | [DIN](instruction-set/input-output.md#din)     | Decrement & input from port.  |
| 0202   | [IOUT](instruction-set/input-output.md#iout)   | Increment & Output to port.   |
| 0210   | [DLOAD](instruction-set/memory-ops.md#dload)   | Decrement & load from memory. |
| 0211   | [ISTORE](instruction-set/memory-ops.md#istore) | Increment & store to memory.  |
